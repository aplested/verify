...
from PySide6.QtWidgets import QPushButton, QApplication, QMainWindow, QWidget, QGridLayout, QMessageBox, QFileDialog,  QGroupBox, QHBoxLayout, QRadioButton, QDialog, QVBoxLayout, QCheckBox, QButtonGroup, QFrame, QLineEdit, QLabel
...
class VerifyMainWindow(QMainWindow):
    ...
    def createControlsWidgets(self):
        ...
        # load dataset button
        loadDataBtn = QPushButton('Load traces')
        loadDataBtn.clicked.connect(self.loadTraces)
        fileGrid.addWidget(loadDataBtn, 1, 0)
        
        self.input_filename_label = QLabel("No data loaded yet")
        ...
        unitaryAmp_label = QLabel("Unitary Current Amplitude (pA)")
        ...
        decimation_label = QLabel("Decimation (pts)")###'0, 50'
        ...
        bsRange_label = QLabel("Baseline range (pts)")###'0, 50'
        ...
        self.verifyTracesBtn = QPushButton('Verify traces')
        ...
        self.central_layout.addWidget(controls, 0, 0, 1, 2)
        return
    ...
    def createPlotWidgets(self):
        ...
        self.central_layout.addWidget(self.plots, 1, 0, 1, 1)

...
# Python 3 version by Rosario Vicidomini and Andrew Plested
...
class verifyGUI:
    ...
    * Traces that exceed the 7 SD limit are removed and the failing points are explicitly listed to the terminal.
    ...
    def __init__(self, master):
        ...
        menubar.add_cascade(label="Verify", menu=statmenu)
    ...
    def getOutputFilename(self):
        try:
            userFilename = tkinter.filedialog.askopenfilename()
        except:
